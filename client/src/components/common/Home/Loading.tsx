...
export default function SteamLoadingIcon() {
    return (
        <div data-aos="zoom-in" data-aos-duration="1000">
            <SteamIcon xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-steam text-info">
            ...
            <Spinner className="spinner-border text-info-emphasis" role="status" />
        </div>
    );
}