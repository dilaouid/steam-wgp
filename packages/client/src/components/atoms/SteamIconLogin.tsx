...
const StyledSteamIconLogin = styled.svg`
    margin-right: 10px;
`;

export const SteamIconLogin: React.FC = () => {
    return <StyledSteamIconLogin xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-steam">
